...
EOF;
    ...
    header("Location: match_player_selection3.php?id=" . $id);
    exit();
}
            ...
            <form action="" method="post">
                <div class="col-lg-6 border"><h3><?php echo htmlspecialchars($row_match_details['home_team']); ?></h3>
                    <div class="input-group mb-3">
                        ...
                        <label style="width: 200px;">ФИО</label>
                        <label style="width: 60px;">Номер</label>
                        <label style="width: 60px;">Порядок</label>
                        <label style="width: 60px;">Основа</label>
                        <label style="width: 60px;">Замена</label>
                        <label style="width: 60px;">Незаявлен</label>
                    </div>
