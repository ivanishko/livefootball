...
if (isset($_POST['insert_card'])
	...
	$match_player_id = intval($_POST['match_player_id']);
	$card_type       = (in_array($_POST['card_type'], array('red', 'yellow', 'second_yellow')) ? $_POST['card_type'] : 'yellow');
				...
				<div class="form-group">
					...
					<select name="match_player_id" class="form-control player_goal_home">
						...
						<?php foreach ($players_team1 as $player) {
							?>
							<option value="<?php echo  $player['id']; ?>"><?php echo ($player['squad_number']. '  '); echo  htmlspecialchars($player['name']);
								?></option>
						<?php } ?>
					</select>
				</div>
			...
			<td>
				...
				<div class="form-group">
					...
					<select name="card_type" class="form-control">
						...
						<option value="second_yellow"><?php echo $label_array[135]; ?></option>
					</select>
				</div>
				<div class="form-group">
					<label><?php echo $label_array[40]; ?></label>
