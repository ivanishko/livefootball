...
<td align="center" valign="top" class="col-md-3">
    ...
    <?php echo 'Гл.тренер ' . htmlspecialchars($row_match_details['home_team_manager']); ?>
                ...
                <td align="left">
                    ...
                    foreach ($cards_team1 as $card) {
                        if ($card['player_id'] == $player['id']) {
                            ...
                            ?>
                            <img
                                src="<?php echo 'img/' . ($card['card_type'] == 'yellow' ? 'yellow_card.png' :
                                        'red_card.png'); ?>"
...
<td align="center" valign="top" class="col-md-3">
    ...
    <br/>
    <?php echo 'Гл.тренер ' . htmlspecialchars($row_match_details['away_team_manager']); ?>
    <br/><br/>
    <table class="table table-bordered" style="font-size: 12px;">
        <tr class="info">
            <?php if ($script_match_type == 'soccer'){ ?>
